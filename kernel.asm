...
801003a0:	e8 bb 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003a5:	c7 04 24 3b 78 10 80 	movl   $0x8010783b,(%esp)
...
80101ea8:	68 22 76 10 80       	push   $0x80107622
...
80103feb:	68 3b 78 10 80       	push   $0x8010783b
...
801049b4:	68 18 76 10 80       	push   $0x80107618
...
801049cc:	68 17 76 10 80       	push   $0x80107617
...
801049e1:	68 0b 76 10 80       	push   $0x8010760b
...
801049ee:	68 1a 76 10 80       	push   $0x8010761a
...
801049fb:	68 fc 75 10 80       	push   $0x801075fc
...
80104e0d:	58                   	pop    %eax
80104e0e:	5a                   	pop    %edx
80104e0f:	68 18 76 10 80       	push   $0x80107618
...
80104e28:	68 17 76 10 80       	push   $0x80107617
...
80104f7d:	68 3c 76 10 80       	push   $0x8010763c
...
80104f8a:	68 4e 76 10 80       	push   $0x8010764e
...
80104f97:	68 2a 76 10 80       	push   $0x8010762a
...
80105463:	83 ec 08             	sub    $0x8,%esp
  yield(); 
80105466:	e8 75 e8 ff ff       	call   80103ce0 <yield>
  return 0;
}
...
80105699:	68 5d 76 10 80       	push   $0x8010765d
...
8010587f:	68 68 76 10 80       	push   $0x80107668
...
801058c1:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
801058c4:	e8 47 ef ff ff       	call   80104810 <syscall>
    if(myproc()->killed)
...
80105938:	68 8c 76 10 80       	push   $0x8010768c
8010593d:	e8 1e ad ff ff       	call   80100660 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
80105942:	83 c4 14             	add    $0x14,%esp
80105945:	68 62 76 10 80       	push   $0x80107662
...
80105a3f:	bb 84 77 10 80       	mov    $0x80107784,%ebx
...
8010664d:	68 8c 77 10 80       	push   $0x8010778c
...
801066f2:	68 26 71 10 80       	push   $0x80107126
...
80106904:	68 92 77 10 80       	push   $0x80107792
...
80106911:	68 bd 77 10 80       	push   $0x801077bd
...
8010691e:	68 a8 77 10 80       	push   $0x801077a8
...
80106990:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
80106991:	e9 2a db ff ff       	jmp    801044c0 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
...
80106999:	68 d1 77 10 80       	push   $0x801077d1
...
80106a4d:	68 eb 77 10 80       	push   $0x801077eb
...
80106a5a:	68 8c 78 10 80       	push   $0x8010788c
...
80106af1:	68 09 78 10 80       	push   $0x80107809
...
80106b23:	68 21 78 10 80       	push   $0x80107821
...
80106d2e:	57                   	push   %edi
80106d2f:	50                   	push   %eax
80106d30:	e8 8b d7 ff ff       	call   801044c0 <memmove>
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
80106d35:	58                   	pop    %eax
80106d36:	5a                   	pop    %edx
80106d37:	8d 93 00 00 00 80    	lea    -0x80000000(%ebx),%edx
80106d3d:	8b 45 e0             	mov    -0x20(%ebp),%eax
80106d40:	ff 75 e4             	pushl  -0x1c(%ebp)
80106d43:	b9 00 10 00 00       	mov    $0x1000,%ecx
80106d48:	52                   	push   %edx
80106d49:	89 f2                	mov    %esi,%edx
80106d4b:	e8 80 f8 ff ff       	call   801065d0 <mappages>
80106d50:	83 c4 10             	add    $0x10,%esp
80106d53:	85 c0                	test   %eax,%eax
80106d55:	78 3e                	js     80106d95 <copyuvm+0xa5>
  uint pa, i, flags;
  char *mem;
...
80106d5d:	39 75 0c             	cmp    %esi,0xc(%ebp)
80106d60:	76 4e                	jbe    80106db0 <copyuvm+0xc0>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106d62:	8b 45 08             	mov    0x8(%ebp),%eax
80106d65:	31 c9                	xor    %ecx,%ecx
80106d67:	89 f2                	mov    %esi,%edx
80106d69:	e8 e2 f7 ff ff       	call   80106550 <walkpgdir>
80106d6e:	85 c0                	test   %eax,%eax
80106d70:	74 5a                	je     80106dcc <copyuvm+0xdc>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106d72:	8b 18                	mov    (%eax),%ebx
80106d74:	f6 c3 01             	test   $0x1,%bl
80106d77:	74 46                	je     80106dbf <copyuvm+0xcf>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106d79:	89 df                	mov    %ebx,%edi
    flags = PTE_FLAGS(*pte);
80106d7b:	81 e3 ff 0f 00 00    	and    $0xfff,%ebx
80106d81:	89 5d e4             	mov    %ebx,-0x1c(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106d84:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106d8a:	e8 01 b7 ff ff       	call   80102490 <kalloc>
80106d8f:	85 c0                	test   %eax,%eax
80106d91:	89 c3                	mov    %eax,%ebx
80106d93:	75 8b                	jne    80106d20 <copyuvm+0x30>
      goto bad;
  }
  return d;
...
80106d98:	ff 75 e0             	pushl  -0x20(%ebp)
80106d9b:	e8 00 fe ff ff       	call   80106ba0 <freevm>
  return 0;
...
80106dbd:	eb e6                	jmp    80106da5 <copyuvm+0xb5>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
...
80106dc2:	68 72 78 10 80       	push   $0x80107872
...
80106dcf:	68 58 78 10 80       	push   $0x80107858
...
80106dee:	e8 5d f7 ff ff       	call   80106550 <walkpgdir>
  if((*pte & PTE_P) == 0)
